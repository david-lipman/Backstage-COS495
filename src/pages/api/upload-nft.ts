...
const handler = nextConnect({
  onError(
    ...
    const errorMessage = `Midlleware error: ${err.message}`;
...
const authenticate = async (
  ...
  console.log("/api/upload-nft: authenticate");
...
const logging = (
  ...
  console.log("/api/upload-nft: incoming request");
  next();
};
